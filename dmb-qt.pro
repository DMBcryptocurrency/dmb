...
isEmpty(QRENCODE_LIB_PATH) {
    ...
    windows:QRENCODE_LIB_PATH=C:/dev/coindeps32/qrencode-3.4.4
}
...
macx:ICON = src/qt/res/icons/Digitalmoneybits.icns
macx:TARGET = "Digitalmoneybits-Qt"
