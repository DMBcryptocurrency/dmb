...
void MasternodeManager::updateNodeList()
{
    ...
    int64_t nSecondsToWait = nTimeListUpdated - GetTime() + 10;
...
void MasternodeManager::on_startButton_clicked()
{
    ...
    if(pwalletMain->IsLocked()) { QMessageBox msg; msg.setText("\n<center>Unlock wallet first."); msg.exec(); return;
    }
...
void MasternodeManager::on_startAllButton_clicked()
{
    ...
    returnObj = "Successfully started " + boost::lexical_cast<std::string>(successful) + " masternodes. \nFailed to start " + boost::lexical_cast<std::string>(fail) + " masternodes." +  "\nTotal " + boost::lexical_cast<std::string>(total) + " masternodes." + "\n ";
    if (fail > 0)
        returnObj += statusObj;
