...
private slots:
    ...
    QString BuyDMB(QString OrderType, double Quantity, double Rate);
    QString SellDMB(QString OrderType, double Quantity, double Rate);
