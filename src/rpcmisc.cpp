...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <Digitalmoneybitsaddress>\n"
            "Return information about <Digitalmoneybitsaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <Digitalmoneybitspubkey>\n"
            "Return information about <Digitalmoneybitspubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <Digitalmoneybitsaddress> <signature> <message>\n"
